...
import com.esisalama.service.mapper.TaskMapper;
...
class TaskResourceIT {
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).priority(DEFAULT_PRIORITY).state(DEFAULT_STATE);
        return task;
    }
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task task = new Task().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).priority(UPDATED_PRIORITY).state(UPDATED_STATE);
        return task;
    }
    ...
    void putExistingTask() throws Exception {
        ...
        updatedTask.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).priority(UPDATED_PRIORITY).state(UPDATED_STATE);
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.description(UPDATED_DESCRIPTION).state(UPDATED_STATE);
    ...
    void fullUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).priority(UPDATED_PRIORITY).state(UPDATED_STATE);
