  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="devTrackersApp.team.home.createOrEditLabel" data-cy="TeamCreateUpdateHeading">
            <Translate contentKey="devTrackersApp.team.home.createOrEditLabel">Create or edit a Team</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('devTrackersApp.team.name')} id="team-name" name="name" data-cy="name" type="text" />
              <ValidatedField
                label={translate('devTrackersApp.team.users')}
                id="team-users"
                data-cy="users"
                type="select"
                multiple
