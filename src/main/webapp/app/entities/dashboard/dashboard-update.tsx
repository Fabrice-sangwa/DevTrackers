...
export const DashboardUpdate = () => {
  ...
  const updating = useAppSelector(state => state.dashboard.updating);
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="devTrackersApp.dashboard.home.createOrEditLabel" data-cy="DashboardCreateUpdateHeading">
            <Translate contentKey="devTrackersApp.dashboard.home.createOrEditLabel">Create or edit a Dashboard</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
