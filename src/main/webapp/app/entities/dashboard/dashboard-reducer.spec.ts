...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './dashboard.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DASHBOARD_LIST actions', async () => {
    ...
    it('dispatches CREATE_DASHBOARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DASHBOARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DASHBOARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DASHBOARD actions', async () => {
      const expectedActions = [
        {
